...
<asp:Content ID="bodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-group">
        ...
        <asp:RequiredFieldValidator ID="rfvCompany" ControlToValidate="txtCompany" ErrorMessage="* Required Field" runat="server" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
    </div>
